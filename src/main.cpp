...
uint256 hashGenesisBlock("0xd113acfb96e64a16dba0f54ddf5a08ef0dd2c955d8650e2f3ad5d9873995a25f");
...
const string strMessageMagic = "Noirbits Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Noirbits miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Noirbits", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbb39a96c25cb83191517e64a1c8b8fb44fec3117fa3af27b12853ad38cf2fb80");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "https://bitcointalk.org/index.php?topic=227047.0";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1370541957; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2186999;

        if (fTestNet)
        {
            block.nTime    = 1370533647;
            block.nNonce   = 461179;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xd67dfc9140e7c2cee6f770b18dfc59d28069ae300a5576d8f40352b9101be3c4"));
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        if (pfrom->nVersion < MIN_PROTO_VERSION && nBestHeight >= MIN_PROTO_VERSION_HEIGHT)
        {
